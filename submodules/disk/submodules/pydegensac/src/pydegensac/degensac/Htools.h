...
extern "C"
#endif
void HDsi(const double *lin, const double * u,
...
extern "C"
#endif
void HDsiSymSum(const double *lin, const double * u,
          const double *H, double *p, int len, int *pts, int ni);

#ifdef __cplusplus
extern "C"
#endif
void HDsiSymSumSq(const double *lin, const double * u,
          const double *H, double *p, int len, int *pts, int ni);
...
extern "C"
#endif
void HDsiSymMax(const double *lin, const double * u,
          const double *H, double *p, int len, int *pts, int ni);

#ifdef __cplusplus
extern "C"
#endif
void HDsiSymMaxSq(const double *lin, const double * u,
          const double *H, double *p, int len, int *pts, int ni);
