...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args += ['-DBLAS_LIBRARIES=' + "C:/Users/fwu/Documents/PhD_FanWU/MyCode/3DGS-bcom-Reloc/lib/bin/libopenblas.dll" ]
        cmake_args += ['-DLAPACK_LIBRARIES=' + "C:/Users/fwu/Documents/PhD_FanWU/MyCode/3DGS-bcom-Reloc/lib/bin/liblapack.dll" ]
...
setup(
    ...
    package_dir={'':'src'},
    ext_modules=[CMakeExtension('pydegensac/pydegensac'), CMakeExtension("pydegensac/pydegensac",  extra_compile_args = [ "-O3", "-std=c++11"])],
